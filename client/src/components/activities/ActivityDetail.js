...
function ActivityDetail({ activityData, onClose }) {
  ...
  const banner = activityData.activityInfoId?.banner || 'https://via.placeholder.com/1200x400';
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="space-y-1">
            ...
            <p className="text-lg font-extrabold text-on-surface">
              {activityData.activityInfoId?.level || 'All Levels'}
            </p>
          </div>
          ...
          <div className="space-y-1">
            ...
            <p className="text-lg font-extrabold text-on-surface">
              {activityData.activityInfoId?.duration || 'N/A'}
            </p>
          </div>
        </div>
        ...
        <button
          ...
          disabled={activityData.status !== 'upcoming' || enrolled >= capacity}
